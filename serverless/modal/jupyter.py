...
# ## Overview
#
# Quick snippet showing how to connect to a Jupyter notebook server running 
# inside a Modal container, especially useful for exploring the contents of 
# Modal Volumes.
# 
...
#
# If you want to your Jupyter notebook to run _locally_ and execute remote Modal 
# Functions in certain cells, see the `basic.ipynb` example :)
