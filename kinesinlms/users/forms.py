...
class UserSettingsForm(forms.ModelForm):
    enable_badges = forms.BooleanField(required=False,
                                       help_text=_("Check this option if you want to receive badges "
...
class UserSignupForm(UserCreationForm):
    ...
    agree_to_honor_code = forms.BooleanField(
        required=True,
        label=mark_safe(
            _("I agree to the KinesinLMS <a href='/tos'>"
    ...
    enable_badges = forms.BooleanField(
        required=True,
        initial=True,
        label=mark_safe(_("Enable course badges <a href='/help/badges/' target='_blank'>"
