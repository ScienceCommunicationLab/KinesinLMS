...
class Animations {
    ...
    _createAnimations(e, i) {
        ...
        for (o = t.length - 1; 0 <= o; --o) {
            const c = t[o];
            if ("$" !== c.charAt(0)) if ("options" === c) s.push(...this._animateOptions(e, i)); else {
                var l = i[c];
                let t = n[c];
                var h = a.get(c);
                if (t) {
...
function updateStacks(t, e) {
    ...
    var s = i._stacks || (i._stacks = {}), {iScale: t, vScale: n, index: r} = a, o = t.axis, l = n.axis,
        h = getStackKey(t, n, a), c = e.length;
    let d;
    for (let t = 0; t < c; ++t) {
        const p = e[t];
        var {[o]: u, [l]: g} = p;
...
class DatasetController {
    ...
    parse(t, e) {
        ...
        const r = s.axis;
        let o = 0 === t && e === a.length || i._sorted, l = 0 < t && i._parsed[t - 1], h, c, d;
        if (!1 === this._parsing) i._parsed = a, i._sorted = !0, d = a; else {
    ...
    parsePrimitiveData(t, e, i, a) {
        ...
        const c = new Array(a);
        let d, u, g;
        for (d = 0, u = a; d < u; ++d) g = d + i, c[d] = {[r]: h || s.parse(l[g], g), [o]: n.parse(e[g], g)};
        return c
    }
    ...
    parseArrayData(t, e, i, a) {
        ...
        let o, l, h, c;
        for (o = 0, l = a; o < l; ++o) c = e[h = o + i], r[o] = {x: s.parse(c[0], h), y: n.parse(c[1], h)};
        return r
    }
...
class BarController extends DatasetController {
    ...
    updateElements(e, i, a, s) {
        ...
        var l = o.getBasePixel(), h = o.isHorizontal(), c = this._getRuler(), {
            sharedOptions: d,
            includeOptions: u
        ...
        for (let t = i; t < i + a; t++) {
            var g = this.getParsed(t),
                ...
                f = this._calculateBarIndexPixels(t, c), m = (g._stacks || {})[o.axis];
            const v = {
                horizontal: h,
                base: p.base,
    ...
    _calculateBarValuePixels(t) {
        ...
        let c = o[e.axis], d = 0, u = i ? this.applyStack(e, o, i) : c, g, p;
...
function getRatioAndOffset(t, e, a) {
    ...
    if (e < TAU) {
        ...
        var t = Math.cos(u), e = Math.sin(u), o = Math.cos(g), l = Math.sin(g),
            ...
            c = (t, e, i) => _angleBetween(t, u, g, !0) ? -1 : Math.min(e, e * a, i, i * a), d = h(0, t, o),
            h = h(HALF_PI, e, l), t = c(PI, t, o), o = c(PI + HALF_PI, e, l);
...
class DoughnutController extends DatasetController {
    ...
    update(t) {
        ...
        var a = i.data, s = this.getMaxBorderWidth() + this.getMaxOffset(a) + this.options.spacing,
            ...
            n = Math.min(toPercentage(this.options.cutout, n), 1), r = this._getRingWeight(this.index), {
                circumference: o,
                rotation: l
            } = this._getRotationExtents(), {ratioX: l, ratioY: o, offsetX: h, offsetY: c} = getRatioAndOffset(l, o, n),
    ...
    updateElements(t, e, i, a) {
        var s = "reset" === a, n = this.chart, r = n.chartArea, n = n.options.animation, o = (r.left + r.right) / 2,
            ...
            c = r ? 0 : this.outerRadius, {sharedOptions: d, includeOptions: u} = this._getSharedOptions(e, a);
...
class LineController extends DatasetController {
    ...
    updateElements(e, i, t, a) {
        ...
        var {sharedOptions: h, includeOptions: c} = this._getSharedOptions(i, a), d = n.axis, u = r.axis, {
                spanGaps: g,
                segment: p
...
class PolarAreaController extends DatasetController {
    ...
    updateElements(a, t, e, s) {
        ...
        var h = l.xCenter, c = l.yCenter, d = l.getIndexAngle(0) - .5 * PI;
        let u = d, g;
    ...
    updateElements(e, i, a, s) {
        ...
        for (let t = i; t < i + a; t++) {
            var o = e[t], l = this.resolveDataElementOptions(t, o.active ? "active" : s),
                h = n.getPointPositionForValue(t, this.getParsed(t).r), c = r ? n.xCenter : h.x,
                d = r ? n.yCenter : h.y, h = {x: c, y: d, angle: h.angle, skip: isNaN(c) || isNaN(d), options: l};
...
class ScatterController extends DatasetController {
    ...
    updateElements(e, i, a, s) {
        ...
        var t = this.resolveDataElementOptions(i, s), c = this.getSharedOptions(t), d = this.includeOptions(s, c),
        ...
        for (let t = i; t < i + a; ++t) {
            ...
            const M = v ? b : {};
            var y = isNullOrUndef(_[g]), k = M[u] = r.getPixelForValue(_[u], t),
...
class Scale extends Element {
    ...
    fit() {
        ...
        var e, i, a, s, n, {chart: r, options: {ticks: o, title: l, grid: h}} = this, c = this._isVisible(),
            d = this.isHorizontal();
    ...
    _calculatePadding(i, a, s, n) {
        ...
        if (this.isHorizontal()) {
            var c = this.getPixelForTick(0) - this.left, d = this.right - this.getPixelForTick(this.ticks.length - 1);
            let t = 0, e = 0;
    ...
    _computeLabelSizes(t, e, i) {
        ...
        let l = 0, h = 0, c, d, u, g, p, f, m, v, x, b, _;
        for (c = 0; c < e; c += o) {
            if (g = t[c].label, p = this._resolveTickFontOptions(c), a.font = f = p.string, m = s[f] = s[f] || {
                ...
                if (isArray(g)) for (d = 0, u = g.length; d < u; ++d) _ = g[d], isNullOrUndef(_) || isArray(_) || (x = _measureText(a, m.data, m.gc, x, _), b += v)
    ...
    _computeGridLineItems(t) {
        ...
        var o = s.offset, l = this.isHorizontal(), h = this.ticks.length + (o ? 1 : 0), c = getTickMarkLength(s);
        const d = [];
        ...
        var e = valueOrDefault(a.ticks.maxTicksLimit, h), A = Math.max(1, Math.ceil(h / e));
        for (x = 0; x < h; x += A) {
    ...
    _computeLabelItems(t) {
        ...
        var n, r = this.isHorizontal(), o = this.ticks, {align: l, crossAlign: h, padding: c, mirror: d} = s,
            i = getTickMarkLength(i.grid), u = i + c, c = d ? -c : u, g = -toRadians(this.labelRotation);
        const p = [];
        ...
        for (f = 0, m = o.length; f < m; ++f) {
            ...
            var C = s.setContext(this.getContext(f)),
                ...
                O = C.color, L = C.textStrokeColor, T = C.textStrokeWidth;
            let t = _;
            ...
            if (C.showLabelBackdrop) {
                var A = toPadding(C.backdropPadding), E = w.heights[f], I = w.widths[f];
                let t = D - A.top, e = 0 - A.left;
                switch (P) {
                    case"middle":
                        t -= E / 2;
                        break;
    ...
    drawBorder() {
        ...
        if (l) {
            var h = r.setContext(this.getContext(0)).lineWidth, c = this._borderValue;
            let t, e, i, a;
...
function mergeScaleConfig(e, i) {
    const n = overrides[e.type] || {scales: {}}, r = i.scales || {}, o = getIndexAxis(e.type, i),
    ...
    return Object.keys(r).forEach(t => {
        ...
        var i = determineAxis(t, e), a = getDefaultScaleIDFromAxis(i, o), s = n.scales || {};
        l[t] = mergeIf(Object.create(null), [{axis: i}, e, s[i], s[a]])
    }), e.data.datasets.forEach(a => {
        var t = a.type || e.type;
        const s = a.indexAxis || getIndexAxis(t, i), n = (overrides[t] || {}).scales || {};
...
function pathArc(t, e, i, a, s, n) {
    var {x: r, y: o, startAngle: l, pixelMargin: h, innerRadius: c} = e, d = Math.max(e.outerRadius + a + i - h, 0),
        h = 0 < c ? c + a + i + h : 0;
    let u = 0;
    var g = s - l,
        c = (a && (c = ((0 < c ? c - a : 0) + (0 < d ? d - a : 0)) / 2, u = (g - (0 != c ? g * c / (c + a) : g)) / 2), Math.max(.001, g * d - i / PI) / d),
        a = (g - c) / 2, i = l + a + u, g = s - a - u, {
            outerStart: c,
            outerEnd: l,
            innerStart: s,
            innerEnd: a
        } = parseBorderRadius$1(e, h, d, g - i), e = d - c, p = d - l, f = i + c / e, m = g - l / p, v = h + s, x = h + a,
        b = i + s / v, _ = g - a / x;
...
function drawBorder(e, i, a, s, n) {
    var {fullCircles: r, startAngle: o, circumference: l, options: h} = i, {borderWidth: c, borderJoinStyle: d} = h,
...
class ArcElement extends Element {
    ...
    inRange(t, e, i) {
        var a = this.getProps(["x", "y"], i), {angle: a, distance: t} = getAngleFromPoint(a, {
            ...
            o = this.options.spacing / 2, r = valueOrDefault(r, i - e), r = TAU <= r || _angleBetween(a, e, i),
...
function pathSegment(t, e, i, a) {
    ...
    let {move: c = !0, reverse: d} = a || {}, u, g, p;
...
class LineElement extends Element {
    ...
    interpolate(i, a) {
        ...
        if (o.length) {
            const d = [], u = _getInterpolationMethod(s);
            let t, e;
            for (t = 0, e = o.length; t < e; ++t) {
                var {start: l, end: h} = o[t], l = r[l], h = r[h];
                if (l === h) d.push(l); else {
...
function lttbDecimation(a, s, n, t, e) {
    ...
    for (r[l++] = a[h], c = 0; c < i - 2; c++) {
        let t = 0, e = 0, i;
        var f = Math.floor((c + 1) * o) + 1 + s, m = Math.min(Math.floor((c + 2) * o) + 1, n) + s, v = m - f;
        for (i = f; i < m; i++) t += a[i].x, e += a[i].y;
        t /= v, e /= v;
        var f = Math.floor(c * o) + 1 + s, x = Math.min(Math.floor((c + 1) * o) + 1, n) + s, {x: b, y: _} = a[h];
...
function minMaxDecimation(t, e, i, a) {
    let s = 0, n = 0, r, o, l, h, c, d, u, g, p, f;
    const m = [];
...
function fill(e, t) {
    ...
    for ({source: o, target: l, start: h, end: c} of _segments(i, a, s)) {
        var {style: {backgroundColor: d = n} = {}} = o, u = !0 !== a,
            d = (e.save(), e.fillStyle = d, clipBounds(e, r, u && _getBounds(s, h, c)), e.beginPath(), !!i.pathSegment(e, o));
        let t;
...
class Legend extends Element {
    ...
    _fitCols(t, a, s, n) {
        const {ctx: r, maxHeight: e, options: {labels: {padding: o}}} = this, l = this.legendHitBoxes = [],
            h = this.columnSizes = [], c = e - t;
        let d = o, u = 0, g = 0, p = 0, f = 0;
        return this.legendItems.forEach((t, e) => {
    ...
    _draw() {
        ...
        const {boxWidth: D, boxHeight: P, itemHeight: w} = getBoxSize(v, k), C = this.isHorizontal(),
            A = this._computeTitleHeight(), O = (M = C ? {
    ...
    drawTitle() {
        ...
        if (s.display) {
            const h = getRtlAdapter(a.rtl, this.left, this.width), c = this.ctx;
...
function getTooltipSize(t, e) {
    ...
    var {boxWidth: r, boxHeight: o} = e, l = toFont(e.bodyFont), h = toFont(e.titleFont), c = toFont(e.footerFont),
        d = n.length, u = s.length, g = a.length, p = toPadding(e.padding);
    let f = p.height, m = 0;
    ...
    }), x = 0, i.font = c.string, each(t.footer, b), i.restore(), {width: m += p.width, height: f}
}
...
class Tooltip extends Element {
    ...
    getCaretPosition(t, e, i) {
        var {xAlign: a, yAlign: s} = this, {caretSize: i, cornerRadius: n} = i, {
            ...
            bottomLeft: o,
            bottomRight: l
        } = toTRBLCorners(n), {x: t, y: h} = t, {width: e, height: c} = e;
        let d, u, g, p, f, m;
    ...
    _drawColorBox(t, e, i, a, s) {
        var n, r = this.labelColors[i], o = this.labelPointStyles[i], {boxHeight: l, boxWidth: h, boxPadding: c} = s,
            d = toFont(s.bodyFont), u = getAlignedX(this, "left", s), u = a.x(u),
...
function generateTicks$1(t, e) {
    const i = [];
    var {bounds: a, step: s, min: n, max: r, precision: o, count: l, maxTicks: h, maxDigits: c, includeBounds: d} = t,
        u = s || 1, g = h - 1, {min: e, max: p} = e, f = !isNullOrUndef(n), m = !isNullOrUndef(r),
        v = !isNullOrUndef(l), c = (p - e) / (c + 1);
...
function fitWithPointLabels(e) {
    ...
    for (let t = 0; t < r; t++) {
        var h = o.setContext(e.getPointLabelContext(t)),
            c = (n[t] = h.padding, e.getPointPosition(t, e.drawingArea + n[t], l)), h = toFont(h.font),
            h = measureLabelSize(e.ctx, h, e._pointLabels[t]), d = (s[t] = h, _normalizeAngle(e.getIndexAngle(t) + l)),
...
function buildPointLabelItems(e, i, a) {
    const s = [];
    var n = e._pointLabels.length, t = e.options, r = getTickBackdropHeight(t) / 2, o = e.drawingArea,
        l = t.pointLabels.centerPointLabels ? PI / n : 0;
    for (let t = 0; t < n; t++) {
        var h = e.getPointPosition(t, o + r + a[t], l), c = Math.round(toDegrees(_normalizeAngle(h.angle + HALF_PI))),
            d = i[t], u = yForAngle(h.y, d.h, c), c = getTextAlignForAngle(c), g = leftForTextAlign(h.x, d.w, c);
...
function drawPointLabels(e, i) {
    ...
    for (let t = i - 1; 0 <= t; t--) {
        var n, r, o, l = s.setContext(e.getPointLabelContext(t)), h = toFont(l.font), {
            x: c,
            y: d,
            textAlign: u,
            left: g,
            ...
            right: f,
            bottom: m
        } = e._pointLabelItems[t], v = l["backdropColor"];
    ...
    drawGrid() {
        ...
        if (e.pointLabels.display && drawPointLabels(this, n), a.display && this.ticks.forEach((t, e) => {
            ...
            for (t.save(), r = n - 1; 0 <= r; r--) {
                var h = i.setContext(this.getPointLabelContext(r)), {color: c, lineWidth: d} = h;
