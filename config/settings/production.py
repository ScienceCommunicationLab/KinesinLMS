...
LOGGING = {
    ...
    "loggers": {
        ...
        "kinesinlms.assessments": {"level": "DEBUG", "handlers": ["console"]},
        "kinesinlms.catalog": {"level": "DEBUG", "handlers": ["console"]},
        "kinesinlms.core": {"level": "DEBUG", "handlers": ["console"]},
        "kinesinlms.course": {"level": "DEBUG", "handlers": ["console"]},
        "kinesinlms.dashboard": {"level": "DEBUG", "handlers": ["console"]},
        "kinesinlms.discourse": {"level": "DEBUG", "handlers": ["console"]},
        "kinesinlms.educator_resources": {"level": "DEBUG", "handlers": ["console"]},
        "kinesinlms.learning_library": {"level": "DEBUG", "handlers": ["console"]},
        "kinesinlms.management": {"level": "DEBUG", "handlers": ["console"]},
        "kinesinlms.sits": {"level": "DEBUG", "handlers": ["console"]},
        "kinesinlms.marketing": {"level": "DEBUG", "handlers": ["console"]},
        "kinesinlms.pathways": {"level": "DEBUG", "handlers": ["console"]},
        "kinesinlms.survey": {"level": "DEBUG", "handlers": ["console"]},
        "kinesinlms.tracking": {"level": "DEBUG", "handlers": ["console"]},
        "kinesinlms.users": {"level": "DEBUG", "handlers": ["console"]},
        "kinesinlms.speakers": {"level": "DEBUG", "handlers": ["console"]},
        "kinesinlms.badges": {"level": "DEBUG", "handlers": ["console"]},
        # Quiet down loggers from dependencies.
        # Otherwise heroku logs get really messy.
        "boto3": {"level": "CRITICAL", "handlers": ["console"]},
        "botocore": {"level": "CRITICAL", "handlers": ["console"]},
    },
}
...
SPECTACULAR_SETTINGS["SERVERS"] = [  # noqa: F405
    {
        ...
        "url": "https://kinesinlms.herokuapp.com",
...
# KinesinLMS Specific
# ------------------------------------------------------------------------------
# Most of the above configuration comes from Django cookie cutter.
# KinesinLMS specific configuration starts here....
